      ...
      <div id="start" style={{ background: "#eef0ff", padding: "60px 20px" }}>
        <div style={{ maxWidth: "820px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "14px" }}>
            {[
              { color: "#cc6600", title: " Unix (1969)", text: 'Unix was the GRANDFATHER of all operating systems. Made in 1969 by Bell Labs. Linux is basically inspired by it. Even macOS uses Unix underneath!' },
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", border: "3px solid black", fontSize: "15px", minWidth: "500px" }}>
              ...
              <tbody>
                {[
                  ...
                  { cat: " Viruses", win: "More viruses target it (more users = more targets)", lin: "Way fewer viruses in the wild" },
                  { cat: " Software", win: "Almost every app works on Windows", lin: "Some apps don't work (but alternatives exist)" },
                  { cat: " Customizing", win: "Some options, but limited", lin: "You can change LITERALLY EVERYTHING" },
        ...
        <div style={{ maxWidth: "820px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "14px" }}>
            {[
              ...
              { icon: "", title: "Cloud Computing", text: "Google, Amazon, and Microsoft all run their cloud servers on Linux. Even Microsoft uses Linux!" },
            ].map((item, i) => (
